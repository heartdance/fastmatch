...
/**
 * Tests for {@link StartWithRuleMatcher}
 *
 * Created by htf on 2021/3/26.
 */
public class StartWithRuleMatcherTest {

    private final StartWithRuleMatcher<StringRule> matcher = new StartWithRuleMatcher<>();
    ...
    public void testOneRule() {
        StringRule rule = new StringRule(StringRule.Type.START_WITH, "test");
    ...
    public void testOneMoreRule() {
        StringRule rule1 = new StringRule(StringRule.Type.START_WITH, "test");
        StringRule rule2 = new StringRule(StringRule.Type.START_WITH, "test1");
        StringRule rule3 = new StringRule(StringRule.Type.START_WITH, "test2");
    ...
    public void testSameRule() {
        ...
        List<StringRule> result = matcher.match("test suf");
        Assert.assertEquals(2, result.size());
        Assert.assertEquals(rule, result.get(0));
